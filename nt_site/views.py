...
from nt_site.models import Section, Publication, Settings
...
def root(request):
    try:
        ...
        return render(request, 'nt_site/publications.html', context)
...
def publication(request, section, publication):
    try:
        ...
        return render(request, 'nt_site/publication.html', context)
