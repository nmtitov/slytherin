...
#     section_model = apps.get_model("nt_site", "Section")
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail_image', models.OneToOneField(to='nt_site.Image', related_name='thumbnail_image', blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='image',
            name='post',
            field=models.ForeignKey(to='nt_site.Post'),
        ...
        migrations.AddField(
            model_name='post',
            name='section',
            field=models.ForeignKey(on_delete=models.deletion.PROTECT, related_name='posts', to='nt_site.Section'),
        ),
        migrations.CreateModel(
            name='Settings',
            fields=[
